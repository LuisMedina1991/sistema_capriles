...
<body>
    <header>
        <table width="100%">
            ...
            <tr>
                <td class="text-center">
                    <span style="font-size: 20px; font-weigth: bold;">Clientes por Cobrar</span>
                </td>
            </tr>
            <tr>
                <td class="text-center">
        ...
        <table cellpadding="0" cellspacing="0" class="table-items" width="100%">
            ...
            <tbody>
                @foreach ($clients as $client)
                    <tr>
                        <td align="center">{{ $client->costumer }}</td>
                        <td align="center">{{ $client->description }}</td>
                        <td align="center">${{number_format($client->amount,2)}}</td>
                    </tr>
                @endforeach
            </tbody>
        </table>
