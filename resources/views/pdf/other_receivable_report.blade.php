...
<body>
    <header>
        <table width="100%">
            ...
            <tr>
                <td class="text-center">
                    <span style="font-size: 20px; font-weigth: bold;">Otros por Cobrar</span>
                </td>
            </tr>
            <tr>
                <td class="text-center">
        ...
        <table cellpadding="0" cellspacing="0" class="table-items" width="100%">
            ...
            <tbody>
                @foreach ($others as $other)
                    <tr>
                        <td align="center">{{ $other->reference }}</td>
                        <td align="center">{{ $other->description }}</td>
                        <td align="center">${{number_format($other->amount,2)}}</td>
                    </tr>
                @endforeach
            </tbody>
        </table>
