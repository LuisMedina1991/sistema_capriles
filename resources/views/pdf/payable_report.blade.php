...
<body>
    <header>
        <table width="100%">
            ...
            <tr>
                <td class="text-center">
                    <span style="font-size: 20px; font-weigth: bold;">Otros por Pagar</span>
                </td>
            </tr>
            <tr>
                <td class="text-center">
        ...
        <table cellpadding="0" cellspacing="0" class="table-items" width="100%">
            ...
            <tbody>
                @foreach ($payables as $payable)
                    <tr>
                        <td align="center">{{ $payable->reference }}</td>
                        <td align="center">{{ $payable->description }}</td>
                        <td align="center">${{number_format($payable->amount,2)}}</td>
                    </tr>
                @endforeach
            </tbody>
        </table>
