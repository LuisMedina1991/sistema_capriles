                ...
                <div class="table-responsive">
                    <table class="table table-striped table-bordered mt-1">
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td><h6 class="text-center">{{ $state->name }}</h6></td>
                                <td class="text-center">
                                    @can('editar_registro')
                                    <a href="javascript:void(0)" wire:click="Edit({{$state->id}})" class="btn btn-dark mtmobile" title="Editar">
                                        <i class="fas fa-edit"></i>
                                    </a>
                                    @endcan
                                    @can('eliminar_registro')
                                    <a href="javascript:void(0)" onclick="Confirm('{{$state->id}}')" class="btn btn-dark" title="Eliminar">
