                    ...
                    <table class="table table-bordered table-striped mt-1">
                        <thead class="text-white" style="background: #3B3F5C">
                            <tr>
                                ...
                                <th class="table-th text-white text-center">TIPO DE EMPRESA</th>
                                <th class="table-th text-white text-center">CATEGORIA DE EMPRESA</th>
                        ...
                        <tbody>
                            ...
                            <tr>
                                <td><h6 class="text-center">{{$company->description}}</h6></td>
                                <td><h6 class="text-center">{{$company->nit}}</h6></td>                            
                                <td><h6 class="text-center">{{$company->type}}</h6></td>
                                <td><h6 class="text-center">{{$company->category}}</h6></td>
                                <td><h6 class="text-center">{{$company->address}}</h6></td>
                                <td class="text-center">
                                    @can('editar_registro')
                                    <a href="javascript:void(0)" wire:click.prevent="Edit({{$company->id}})" class="btn btn-dark mtmobile" title="Editar">
                                        <i class="fas fa-edit"></i>
                                    </a>
                                    @endcan
                                    @can('eliminar_registro')
                                    <a href="javascript:void(0)" onclick="Confirm('{{$company->id}}')" class="btn btn-dark" title="Eliminar">
