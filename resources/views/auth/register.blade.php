@extends('layouts.main', ['class' => 'off-canvas-sidebar', 'activePage' => 'register', 'title' => __('Importadora Capriles')])
      ...
      <form class="form" method="POST" action="{{ route('register') }}">
        ...
        <div class="card card-login card-hidden mb-3">
          ...
          <div class="card-body ">
            ...
            <div class="bmd-form-group{{ $errors->has('password_confirmation') ? ' has-danger' : '' }} mt-3">
              <div class="input-group">
                ...
                <input type="password" name="password_confirmation" id="password_confirmation" class="form-control" placeholder="{{ __('Confirme Contraseña...') }}" required autocomplete="new-password">
              </div>
          ...
          <div class="card-footer justify-content-center">
            <button type="submit" class="btn btn-dark btn-lg">{{ __('Crear cuenta') }}</button>
          </div>
        </div>
      </form>
    </div>
